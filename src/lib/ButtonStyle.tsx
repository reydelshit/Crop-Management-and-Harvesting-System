    ...
    <Button
      ...
      className={`mt-2 w-[10rem] h-[3.5rem] ${
        background === 'red'
          ...
          : 'bg-primary-yellow font-bold text-xl text-primary-red hover:bg-primary-red hover:text-primary-yellow transition-all duration-300 ease-in-out hover:border-primary-yellow hover:border-4'
